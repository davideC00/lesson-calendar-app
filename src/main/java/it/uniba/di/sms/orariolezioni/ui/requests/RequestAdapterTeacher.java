...
public class RequestAdapterTeacher extends RecyclerView.Adapter<RequestAdapterTeacher.RequestViewHolder> {
    ...
    RequestAdapterTeacher(Context context, ArrayList<Request> requests, NavController navController){
